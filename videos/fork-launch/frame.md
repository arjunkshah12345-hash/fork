...
typography:
  display: { fontFamily: "Inter, Geist, system-ui, sans-serif", cqw: 7.0, weight: 600, lineHeight: 0.95, tracking: "-0.045em" }
  headline: { fontFamily: "Inter, Geist, system-ui, sans-serif", cqw: 4.2, weight: 600, lineHeight: 1.05, tracking: "-0.03em" }
  body: { fontFamily: "Inter, Geist, system-ui, sans-serif", cqw: 2.0, weight: 400, lineHeight: 1.5 }
  kicker: { fontFamily: "JetBrains Mono, Geist Mono, monospace", cqw: 1.4, weight: 500, tracking: "0.22em", upper: true }
  mono: { fontFamily: "JetBrains Mono, Geist Mono, monospace", cqw: 1.6, weight: 400, lineHeight: 1.5 }
  number: { fontFamily: "JetBrains Mono, Geist Mono, monospace", cqw: 5.2, weight: 500, lineHeight: 1.0, tracking: "-0.03em" }
